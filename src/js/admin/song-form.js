    ...
    let view = {
        ...
        template: `
            <form class="form">
                ...
                <div class="row"> <label>封面：<input name="cover" type="text" value ="__cover__"></label></div>
                <div class="row"> <label>歌词：</label><textarea name="lyrics" cols="70" rows="10">__lyrics__</textarea></div>
